...
void FirewireDevice::readConfigRom()
{
  ...
  else
  {
    ...
    for (i = 0; i < len; i++)
    {
      ...
      {
      case 0x0c:
        configRom.node_capabilities = value;
        break;
      case 0x03:
      ...
      case 0x8d:
        ...
        break;
      case 0x81:
        textual_leaf_addr = addr + value * 4;
        break;
    ...
    if (unit_dir_addr > 0)
    {
      ...
      for (i = 0; i < len; i++)
      {
        ...
        {
        case 0x12:
          configRom.unit_spec_id = value;
          break;
        case 0x13:
          configRom.unit_sw_version = value;
          break;
        case 0x17:
          configRom.model_id = value;
          break;
        }
      }
    }
